...
namespace Lykke.Service.PlaceOrderBook
{
    public class Startup
    {
        ...
        private static ILog CreateLogWithSlack(IServiceCollection services, IReloadingManager<AppSettings> settings)
        {
            ...
            var dbLogConnectionStringManager = settings.Nested(x => x.PlaceOrderBookService.Db.LogsConnString);
            ...
            var persistenceManager = new LykkeLogToAzureStoragePersistenceManager(
                AzureTableStorage<LogEntity>.Create(dbLogConnectionStringManager, "PlaceOrderBookLog", consoleLogger),
                consoleLogger);
